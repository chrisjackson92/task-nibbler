...
|:---|:------|:-----|:-------|
| [PRJ-001](../05_PROJECT/PRJ-001_product_vision_and_features.md) | Product Vision & Feature Roadmap (Template) | planning | DRAFT |
| [BCK-001](../05_PROJECT/BCK-001_Developer_Backlog.md) | Developer Backlog (Template) | planning | DRAFT |
| [BCK-002](../05_PROJECT/BCK-002_Architect_Backlog.md) | Architect Backlog (Template) | planning | DRAFT |
| *(add SPR-NNN sprint documents as the project progresses)* | | | |
...
| [GOV-008](../10_GOVERNANCE/GOV-008_InfrastructureAndOperations.md) | Infrastructure & Operations Standard | reference | DRAFT |
| [GOV-009](../10_GOVERNANCE/GOV-009_SafeCommandExecution.md) | Safe Command Execution | reference | APPROVED |
...
| [BLU-002](../20_BLUEPRINTS/BLU-002_Database_Schema.md) | Database Schema Blueprint (Template) | reference | DRAFT |
| [BLU-002-SD](../20_BLUEPRINTS/BLU-002-SD_Seed_Data_Reference.md) | Seed Data Reference (Template) | reference | DRAFT |
| [BLU-003](../20_BLUEPRINTS/BLU-003_Backend_Architecture.md) | Backend Architecture Blueprint (Template) | reference | DRAFT |
| [BLU-004](../20_BLUEPRINTS/BLU-004_Frontend_Architecture.md) | Frontend Architecture Blueprint (Template) | reference | DRAFT |
| [CON-001](../20_BLUEPRINTS/CON-001_Transport_Contract.md) | Transport Contract (Template) | reference | DRAFT |
| [CON-002](../20_BLUEPRINTS/CON-002_API_Contract.md) | API Contract (Template) | reference | DRAFT |
| *(add project-specific BLU- and CON- docs as the project grows)* | | | |
...
| ID | Title | Type | Status |
|:---|:------|:-----|:-------|
| *(empty — add RUN- runbooks as the project's operational needs are defined)* | | | |
...
| [AGT-002-BE](../80_AGENTS/AGT-002-BE_Backend_Developer_Boot.md) | Backend Developer Boot Doc (Template) | reference | DRAFT |
| [AGT-002-FE](../80_AGENTS/AGT-002-FE_Frontend_Developer_Boot.md) | Frontend Developer Boot Doc (Template) | reference | DRAFT |
...
| [template_agent_boot.md](../_templates/template_agent_boot.md) | AGT- Boot Doc | Creating a project-specific agent onboarding doc |
