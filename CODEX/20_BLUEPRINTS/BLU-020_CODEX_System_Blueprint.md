...
related: [GOV-001, GOV-002, GOV-003, GOV-004, GOV-005, GOV-006, GOV-007]
created: 2026-03-17
updated: 2026-03-17
version: 1.0.0
---
...
| 30_RUNBOOKS — for project-specific runbooks | *(add as project grows)* |
...
## 9. Multi-Agent Swarm Integration

The CODEX is designed to work with multi-agent swarm engines. Each area maps naturally to a swarm stage:

| Swarm Stage | CODEX Area | How It Uses CODEX |
|:------------|:-----------|:-----------------|
| Researcher | `70_RESEARCH/` | Outputs feed research docs |
| Architect | `60_EVOLUTION/` | Generates task backlogs |
| Coder | `20_BLUEPRINTS/` | Implements specs from blueprint docs |
| Tester | `40_VERIFICATION/` | Produces verification reports |

Setup and recovery procedures for your chosen swarm engine should be documented in `30_RUNBOOKS/`.
