...
1. `[project-codex]/CODEX/00_INDEX/MANIFEST.yaml` — document map
2. `[project-codex]/CODEX/80_AGENTS/[THIS_FILE]` — your role (this document)
3. `[project-codex]/CODEX/10_GOVERNANCE/GOV-007_AgenticProjectManagement.md` — PM system
4. `[project-codex]/CODEX/10_GOVERNANCE/GOV-005_AgenticDevelopmentLifecycle.md` — dev lifecycle
5. `[project-codex]/CODEX/05_PROJECT/SPR-NNN.md` — your current sprint
6. `[project-codex]/CODEX/20_BLUEPRINTS/CON-NNN.md` — your binding contracts
7. `[project-codex]/CODEX/10_GOVERNANCE/GOV-003_CodingStandard.md` — coding rules
8. `[project-codex]/CODEX/10_GOVERNANCE/GOV-004_ErrorHandlingProtocol.md` — error handling
9. `[project-codex]/CODEX/10_GOVERNANCE/GOV-006_LoggingSpecification.md` — logging
